...
### Description
Solve below questionnaires by SQL.

**Question 1**
 Want to understand more about the movies that families are watching.The following categories are considered family movies: Animation, Children, Classics, Comedy, Family and Music.Create a query that lists each movie, the film category it is classified in, and the number of times it has been rented out.
...
### Files used
1. In this project used PostgreSQL sample database name  DVD rental,  that  can use for learning and practice PostgreSQL.
